...
С самого начала Waves использовала «нетронутую» модель Proof of Stake \(PoS\) \(подробнее о PoS вы можете прочитать [здесь](/ru/platform-features/leased-proof-of-stake-lpos.md) \), предложенную [Nxt] (https://nxtwiki.org/wiki/Whitepaper:Nxt). 
